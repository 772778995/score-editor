...
//			{url: 'images/beijingse.png', value: '"-nb-"', title: '音符背景色',class:"operator cmenu notecolorli",position:"before",type:"notebg",id:"notecolorli"}
	...
	rhythm:{
		...
		name: '节奏',
		imgList: [
			{ url: 'images/jz_wxp_4f.png', value: 'B2', len:'2',title: '', 'class': 'cmenu',position:'rhythm'},
			{ url: 'images/jz_wxp_28.png', value: 'BB', len:'2',title: '', 'class': 'cmenu',position:'rhythm'},
			{ url: 'images/jz_wxp_168.png', value: 'B/B/B', len:'2',title: '', 'class': 'cmenu',position:'rhythm'},
			{ url: 'images/jz_wxp_816.png', value: 'BB/B/', len:'2',title: '', 'class': 'cmenu',position:'rhythm'},
			{ url: 'images/jz_wxp_xqf.png', value: 'B/BB/', len:'2',title: '', 'class': 'cmenu',position:'rhythm'},
			{ url: 'images/jz_wxp_416.png', value: 'B/B/B/B/', len:'2',title: '', 'class': 'cmenu',position:'rhythm'},
			{ url: 'images/jz_wxp_xfd.png', value: 'B3/B/', len:'2',title: '', 'class': 'cmenu',position:'rhythm'},
			{ url: 'images/jz_wxp_hxfd.png', value: 'B/B3/', len:'2',title: '', 'class': 'cmenu',position:'rhythm'},
			{ url: 'images/jz_wxp_3ly.png', value: '(3BBB', len:'2',title: '', 'class': 'cmenu',position:'rhythm'},
			{ url: 'images/jz_wxp_fd64.png', value: 'B/>B/B/B/', len:'2',title: '', 'class': 'cmenu',position:'rhythm'},
			{ url: 'images/jz_wxp_121.png', value: 'BB2B', len:'4',title: '', 'class': 'cmenu',position:'rhythm'},
			{ url: 'images/jz_wxp_31.png', value: 'B3B', len:'4',title: '', 'class': 'cmenu',position:'rhythm'},
			{ url: 'images/jz_wxp_13.png', value: 'BB3', len:'4',title: '', 'class': 'cmenu',position:'rhythm'},
		]
	},
	ruler: {
		code: 'ruler',
...
//				<img src="images/voice_slur_below.png" title="跨声部连音线在下方" class="cmenu" onclick="setVoiceSlur('source',',')" />
	...
	fng:{
		...
		imgList: [
			...
			{url: 'v2/images/nodeseq.png', value: '', class:"cmenu fngstatus",position:"before"},
		]
	},
	gliss:{
		code: 'gliss',
					...
					if( subMen && subMen.checkbox){
						...
						if( 'view' == menuCode){
							switch (subMen.code) {
								...
								case 'pageview':
									// 钢琴键盘
									this.pageView = subMen.isChecked;
...
// $('#' + id).toggleClass('contract');
		...
		pageViewClick:function( pageView ){
...
//				
				...
				src_change();
				var style = $("#target").attr("style")
				style = style.replace("white-space: nowrap;","");
				$("#target").attr("style",style);
				return;
			}
