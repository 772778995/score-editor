...
$(document).ready(function () {
  ...
  $("li[data-code='help']").click(function () {
    if (content_vue.isExe || isAndroid == "1") {
      window.open(
        "https://imusic.ixzds.com/imusic/imusic/pages/course/know_teac_preview.html?IS_KNOW_PREVIEW=1&QUERY_BY_COURSE=1&USER_TYPE=teac&COURSE_ID=CO391c1eab9f0f4c209700f74f9163bf&KNOWLEDGE_ID=COd96dd3217acb4f41a9cbf31940a458&TITLE=创编制谱系统操作手册&ORGCODE=O925d16073b134a43850fef2871d26fb",
        "创编制谱系统操作手册"
      );
      //有时候top.host取值不正确
