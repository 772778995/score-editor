...
var staffTypes = {
		...
		"alto" : headStr + "%%score 1\nV:1 alto\n%%MIDI program 0\nz,8|z,8|z,8|z,8|$z,8|z,8|z,8|z,8|",
		"tenor" : headStr + "%%score 1\nV:1 tenor\n%%MIDI program 0\nz,8|z,8|z,8|z,8|$z,8|z,8|z,8|z,8|",
...
//		%%lyricstandv 1
	...
	$("li[data-code='help']").click(function(){
		...
		if(content_vue.isExe || isAndroid=="1"){
			window.open("https://imusic.ixzds.com/imusic/imusic/pages/course/know_teac_preview.html?IS_KNOW_PREVIEW=1&QUERY_BY_COURSE=1&USER_TYPE=teac&COURSE_ID=CO391c1eab9f0f4c209700f74f9163bf&KNOWLEDGE_ID=COd96dd3217acb4f41a9cbf31940a458&TITLE=创编制谱系统操作手册&ORGCODE=O925d16073b134a43850fef2871d26fb","创编制谱系统操作手册")
			//有时候top.host取值不正确
...
function exportAbc2Pdf(sourceid){
	...
	if(botmargin!=""){
		if(content.indexOf("botmargin")>-1){
			content = content.replace(/%%botmargin.*/g,"%%botmargin " + topmargin*dpi/2.54 + "");
		}else{
...
// 后退
	...
	$(".selectedStatus2").off('click').on('click',function(){
		enabledEditor(this);
	});
	// 剪切
...
function scOpen(){
	...
	if(str=="视唱"){
		...
		var beatTime = 2;
		if(staffInfo.speed){
			beatTime = 60/speed * (staffInfo.speed.meter.bot/staffInfo.meter.bot) * staffInfo.meter.top;
		}
...
function getMenuContent(){
		var arr =  [{"cname" : "钢琴", "cnos" : ",0,1,2,3,4,5,6,7,"},
		...
		{"cname" : "打击乐", "cnos" : ",150,47,112,113,114,115,116,117,118,119,120,121,122,123,124,125,126,127,"},
		...
		{"cname" : "中国", "cnos" : ",15,131,132,133,135,137,138,139,140,141,149,165,166,167,168,169,170,171,172,"},
		...
		{"cname" : "奥尔夫", "cnos" : ",128,129,130,134,151,152,153,154,155,156,157,158,159,160,161,162,163,164,22,136,74,75,76,78,150,112,113,115,117,118,119,"}];
