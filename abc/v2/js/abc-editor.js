...
var toolTemp = {
  ...
  linemark: {
    ...
    imgList: [
      ...
      {
        url: "images/voice_slur_above.png",
        id: "voice_slur_pic",
        value: '"(slur"',
        value2: ")slur",
        position: "surround",
  ...
  gliss: {
    ...
    imgList: [
      ...
      {
        url: "images/jpslid.png",
        value: "!jpslid!",
        class: "cmenu",
        position: "before",
      },
      {
        url: "images/arp_link.png",
        id: "arp_link",
        value: "arp_link",
        class: "cmenu",
      },
      ...
      {
        url: "images/scoop.png",
        value: "!slideru!",
        class: "cmenu",
        position: "before",
      },
      {
        url: "images/jphuayin.png",
        value: "!sliderd2!",
        class: "cmenu",
        position: "before",
      },
  ...
  tremolo: {
    ...
    imgList: [
      ...
      {
        url: "images/tremolo/5.png",
        value: "!/-!",
        class: "cmenu",
        position: "before",
      },
      {
        url: "images/tremolo/6.png",
        value: "!//-!",
        class: "cmenu",
        position: "before",
      },
      {
        url: "images/tremolo/7.png",
        value: "!///-!",
        class: "cmenu",
        position: "before",
      },
  ...
  linkclef: {
    ...
    imgList: [
      {
        url: "images/brace.png",
        value: "brace",
        class: "cmenu",
        type: "linkclef",
      },
      {
        url: "images/bracket.png",
        value: "bracket",
        class: "cmenu",
        type: "linkclef",
      },
    ...
    m: {
      ...
      newScore: {
        ...
        keySignUpList: [
          ...
          { title: "♯F大调", img: "./img/-F.png", val: "F#", isUp: true },
          { title: "♯C大调", img: "./img/-C.png", val: "C#", isUp: true },
        ],
        keySignDownList: [
          { title: "C大调", img: "./img/C.png", val: "C" },
          { title: "F大调", img: "./img/F.png", val: "F" },
          { title: "♭B大调", img: "./img/bB.png", val: "Bb", isDown: true },
          { title: "♭E大调", img: "./img/bE.png", val: "Eb", isDown: true },
          { title: "♭A大调", img: "./img/bA.png", val: "Ab", isDown: true },
          { title: "♭D大调", img: "./img/bD.png", val: "Db", isDown: true },
          { title: "♭G大调", img: "./img/bG.png", val: "Gb", isDown: true },
        ...
        speedNoteList: [
          { val: "4/4", img: "./img/note1.png" },
          { val: "2/4", img: "./img/note2.png" },
      ...
      toolList: [
        ...
        // },
        {
          ...
          imgList: [
            {
              url: "./img/notepanel/tempMark (1).png",
              value: "^",
              title: "升号",
              class: "cmenu",
              position: "before",
        ...
        },
        {
          ...
          imgList: [
            ...
            {
              url: "./img/notepanel/linemark (3).png",
              value: "!ped!",
              title: "踩下",
              class: "cmenu",
              position: "before",
            ...
            {
              url: "./img/notepanel/linemark (5).png",
              value: "!<(!",
              value2: "!<)!",
              title: "渐强",
              class: "cmenu",
            ...
            {
              url: "./img/notepanel/linemark (6).png",
              value: "!>(!",
              value2: "!>)!",
              title: "渐弱",
              class: "cmenu",
            ...
            {
              url: "./img/notepanel/linemark (10).png",
              id: "slurbtn",
              value: "(note)",
              class: "slur cmenu",
              title: "连线",
        ...
        },
        {
          ...
          imgList: [
            ...
            {
              url: "./img/notepanel/grace (12).png",
              value: "!jpslid!",
              class: "cmenu",
              position: "before",
              title: '滑音'
